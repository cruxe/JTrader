...
public class ConfigurableDispatcherServlet extends DispatcherServlet{
	...
	public void setRelativeLocations(Class clazz, String ...relativeLcations) {
		String[] locations = new String[relativeLcations.length];
		String currentPath = ClassUtils.classPackageAsResourcePath(clazz) + "/";
		
		for (int i = 0; i < relativeLcations.length; i++) {
			locations[i] = currentPath + relativeLcations[i];
		}
